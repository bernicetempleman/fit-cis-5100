...
public class List<T> 
{
	...
	public static void concatenation( List l1, List l2)
	{
		...
		{
			// l2 current node is first Node
			l2.currentNode = l2.firstNode;
			
			// loop through l2 and add each node to back of l1			
	...
	public void printAverage()
	{
		...
		System.out.printf("The %s Average is: ", name);
		ListNode<T> current = firstNode;
		
		float total = 0;
		int count = 0;
		
		//while not at end of list, add current node's data to total & increment count
		while (current !=null)
		{
			count++;
		...
		System.out.printf("%f", total/count);
		System.out.println();
	}	
}//end Class List<T>
